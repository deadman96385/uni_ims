 ...
 *****************************************************************************/
#ifndef _VSP_H264_DEC_H_
#define _VSP_H264_DEC_H_
...
**                            Macro Definitions                               *
**---------------------------------------------------------------------------*/
#define H264DEC_OR_RUN_SIZE		                        (0x100000)            //byte unit
#define H264DEC_OR_INTER_START_ADDR		H264DEC_OR_RUN_SIZE
#define H264DEC_OR_INTER_MALLOC_SIZE		(0x100000)	//byte unit
...
typedef struct h264dec_share_ram_info
{
	// Offset 0x0 ;	
