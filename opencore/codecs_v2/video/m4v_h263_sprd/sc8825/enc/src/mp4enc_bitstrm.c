...
#ifdef _VSP_LINUX_
        phy_addr = Mp4Enc_ExtraMem_V2Phy(pVop_mode->pOneFrameBitstream);
        VSP_WRITE_REG(VSP_MEMO10_ADDR+ 8, MAPaddr( phy_addr), "AHBM_FRM_ADDR_6: encoded bitstream buffer0 address");
#else
	VSP_WRITE_REG(VSP_MEMO10_ADDR+ 8, MAPaddr( (uint32)pVop_mode->pOneFrameBitstream), "AHBM_FRM_ADDR_6: encoded bitstream buffer0 address");
#endif
