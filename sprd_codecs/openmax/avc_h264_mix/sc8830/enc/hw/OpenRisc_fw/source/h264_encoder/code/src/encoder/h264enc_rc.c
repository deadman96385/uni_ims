...
//  uint16 GOP_I = GOP_len - GOP_P;					//no. of I pictures in a GOP
	...
	{
		GOP_init_QP = g_h264_enc_config->qp_ISLICE;
	}
	else			//not the first GOP
	{
		rc_gop_paras->total_qp += g_h264_enc_config->qp_PSLICE;
		GOP_init_QP = rc_gop_paras->total_qp / INTRA_PERIOD ;
		//GOP_init_QP = g_input->qp_PSLICE-1;
	}
...
#endif
	}else{GOP_init_QP = g_h264_enc_config->qp_ISLICE;}
