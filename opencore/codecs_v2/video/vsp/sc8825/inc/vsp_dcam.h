...
#define DCAM_CFG_OFF						0x00
#define DCAM_MP4ENC_CTRL_OFF				0x04
#define DCAM_MP4ENC_HEADER_STAT_OFF     0x08
#define DCAM_SRC_SIZE_OFF					0x0C
...
#ifdef SIM_IN_WIN
typedef struct  vsp_dcam_reg_tag
{


	volatile uint32 DCAM_CFG_t;		//[31:10]: RESERVED
    ...
    volatile uint32 DCAM_MP4ENC_CTRL_t;		//[21:1]: TOTAL_SAD
										//[0]: MP4ENC_GLB_CTRL_START: 1: start full hardware encoding
											
	volatile uint32 rsv1_t;

	volatile uint32 DCAM_SRC_SZIE_t;			//Source image size, i.e., input picture size 
											//[31:28]: RESERVED
											//[27:16]: SRC_SIZE_y, Source image Y size, maximum 4092
											//[15:12]: RESERVED
											//[11:0]: SRC_SIZE_X, Source image X size, maximum 4092

	volatile uint32 ISP_DIS_SIZE_t;			//DISPLAY image size, i.e., SCALER output size.  
											//[31:28]: RESERVED
											//[27:16]: DIS_SIZE_y, DISPLAY image Y size
											//[15:12]: RESERVED
											//[11:0]: DIS_SIZE_X, DISPLAY image X size
	volatile uint32 VSP_TIME_OUT_t;			//This register only active in vsp mode		
											//[31:18]: RESERVED
	...
	volatile uint32 rsv2_t[2];

	volatile uint32 DCAM_INT_STS_t;	
											//[31:16]: RESERVED
