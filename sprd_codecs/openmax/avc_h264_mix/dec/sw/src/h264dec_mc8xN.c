...
#if 1 //WIN32
//N: 8 or 16
void MC_luma8xN_dx0dy0 (H264DecContext *vo, uint8 * pRefFrame, uint8 * pPred, int32 N)
{
    int32 i;
...
#if 1 //WIN32
//N: 8 or 16, M: 1 or 3
void MC_luma8xN_dxMdy0 (H264DecContext *vo, uint8 * pRefFrame, uint8 * pPred, int32 N)
{
    int32 i;
    int32 width = vo->ext_width;
...
#if 1 //WIN32
//N: 8 or 16
void MC_luma8xN_yfull (H264DecContext *vo, uint8 * pRefFrame, uint8 * pPred, int32 N)
{
    int32 i;
    int32 width = vo->ext_width;
#ifdef _NEON_OPT_
...
#if 1 //WIN32
//N: 8 or 16, M: 1 or 3
void MC_luma8xN_dx0dyM (H264DecContext *vo, uint8 * pRefFrame, uint8 * pPred, int32 N)
{
    int32 i;
...
#if 1 //WIN32
void MC_luma8xN_xyqpix (H264DecContext *vo, uint8 * pRefFrame, uint8 * pPred, int32 N)
{
    int32 i;
    int32 dx, dy;
    uint8 * pRefHorFilter;
...
#if 1 //WIN32
void MC_luma8xN_xhalf (H264DecContext *vo, uint8 * pRefFrame, uint8 * pPred, int32 N)
{
    int32 dy;
//	uint8 * pRefBlk;
    int32 width = vo->ext_width;
...
void MC_luma8xN_yhalf (H264DecContext *vo, uint8 * pRefFrame, uint8 * pPred, int32 N)
{
    int32 dx;
    int32 width = vo->ext_width;
    int16 *pHalfPix = vo->g_halfPixTemp;
