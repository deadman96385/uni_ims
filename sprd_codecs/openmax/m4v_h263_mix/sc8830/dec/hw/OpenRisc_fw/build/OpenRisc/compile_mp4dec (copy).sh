...
or32-elf-gcc -g -O2 -D_VSP_LINUX_ -nostdlib -T ../../source/link_main.ld -e 0x00000000 -Wl,-Map,mem_main.map -v ${SRC}/main.c ${SRC}/mp4_common_table.c  ${SRC}/mp4dec_malloc.c ${SRC}/mp4dec_interface.c   ${SRC}/mp4dec_global.c  ${SRC}/mp4dec_table.c    ${SRC}/mp4dec_bitstream.c  ${SRC}/mp4dec_bfrctrl.c	${SRC}/mp4dec_vop.c	 ${SRC}/mp4dec_session.c 	${SRC}/mp4dec_header.c	${ORSC_LDFLAGS} -o ${OUT}.elf 2>&1 | tee log_main
...
sed -e '/0x/d' -e '/static/r tmp1.txt' ../../../include/${OUT}_or_fw.h > tmp2.txt
rm tmp1.txt
mv tmp2.txt ../../../include/${OUT}_or_fw.h
