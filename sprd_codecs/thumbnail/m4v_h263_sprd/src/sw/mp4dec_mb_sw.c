 ...
 **	Note:
 *****************************************************************************/
PUBLIC void Mp4Dec_DecIntraMBTexture_sw(VIDEO_DATA_T *vd, DEC_VOP_MODE_T *vop_mode_ptr, DEC_MB_MODE_T *mb_mode_ptr, DEC_MB_BFR_T *mb_cache_ptr)
{
	int32 blk_num;
	uint8 *rgchBlkDst;
	int32 iWidthDst;
 ...
 **	Note:
 *****************************************************************************/
PUBLIC void Mp4Dec_DecInterMBTexture_sw(VIDEO_DATA_T *vd, DEC_VOP_MODE_T *vop_mode_ptr, DEC_MB_MODE_T *mb_mode_ptr, DEC_MB_BFR_T *mb_cache_ptr)
{
 ...
 **	Note:
 *****************************************************************************/
PUBLIC void Mp4Dec_DecInterMBTexture_DP_vt(VIDEO_DATA_T *vd, DEC_VOP_MODE_T *vop_mode_ptr, DEC_MB_MODE_T *mb_mode_ptr, DEC_MB_BFR_T *mb_cache_ptr)
{
	int32 CBP = mb_mode_ptr->CBP;
	int32 iBlkIdx;
	int32 iQP = mb_mode_ptr->StepSize;
