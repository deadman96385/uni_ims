...
void Mp4Dec_UpdateErrInfo (DEC_VOP_MODE_T *vop_mode_ptr);
void Mp4Dec_EC_IVOP (DEC_VOP_MODE_T * vop_mode_ptr);
void Mp4Dec_EC_PVOP (DEC_VOP_MODE_T * vop_mode_ptr);
MMDecRet Mp4Dec_EC_FillMBGap (DEC_VOP_MODE_T *vop_mode_ptr);
