...
void ProxyApplication_OMX::ProcessMessage(TPVCommandId cmdid, OsclAny* cmd)
{
    ...
    switch (cmdid)
    {
        case GET_PARAMS:
        {
			...
			if(! ComponentGetParameter)
			{
				ALOGI("ProxyApplication_OMX::ProcessMessage ComponentGetParameter == NULL");
			}
        ...
        case SET_PARAMS:
	    {
			if(! ComponentSetParameter)
			{
				ALOGI("ProxyApplication_OMX::ProcessMessage ComponentSetParameter == NULL");
			}
        ...
        case GET_CONFIG:
        {
			...
			if(! ComponentGetConfig)
			{
				ALOGI("ProxyApplication_OMX::ProcessMessage ComponentGetConfig == NULL");
			}
        ...
        case SET_CONFIG:
        {
			if(! ComponentSetConfig)
			{
				ALOGI("ProxyApplication_OMX::ProcessMessage ComponentSetConfig == NULL");
			}
        ...
        case GET_EXT:
        {
			if(! ComponentGetExtensionIndex)
			{
				ALOGI("ProxyApplication_OMX::ProcessMessage ComponentGetExtensionIndex == NULL");
			}
        ...
        case GET_ST:
        {
			...
			if(! ComponentGetState)
			{
				ALOGI("ProxyApplication_OMX::ProcessMessage ComponentGetState == NULL");
			}
        ...
        case USE_BUF:
        {
			if(! ComponentUseBuffer)
			{
				ALOGI("ProxyApplication_OMX::ProcessMessage ComponentUseBuffer == NULL");
			}
        ...
        case ALLOC_BUF:
        {
			if(! ComponentAllocateBuffer)
			{
				ALOGI("ProxyApplication_OMX::ProcessMessage ComponentAllocateBuffer == NULL");
			}
        ...
        case FREE_BUF:
        {
			if(! ComponentFreeBuffer)
			{
				ALOGI("ProxyApplication_OMX::ProcessMessage ComponentFreeBuffer == NULL");
			}
        ...
        case SET_CALL:
        {
			...
			if(! ComponentSetCallbacks)
			{
				ALOGI("ProxyApplication_OMX::ProcessMessage ComponentSetCallbacks == NULL");
			}
        ...
        case SEND_COMM:
        {
			...
			if(! ComponentSendCommand)
			{
				ALOGI("ProxyApplication_OMX::ProcessMessage ComponentSendCommand == NULL");
			}
        ...
        case EMPTY_BUF:
        {
			if(! ComponentEmptyThisBuffer)
			{
				ALOGI("ProxyApplication_OMX::ProcessMessage ComponentEmptyThisBuffer == NULL");
			}
        ...
        case FILL_BUF:
        {
			if(! ComponentFillThisBuffer)
			{
				ALOGI("ProxyApplication_OMX::ProcessMessage ComponentFillThisBuffer == NULL");
			}
