    ...
    H264_DecParams *params_ptr)
{
    ...
    OSAL_memSet(obj_ptr, 0, sizeof(H264_DecObj));
...
#ifndef EXCLUDE_FFMPEG_LIBRARY
    obj_ptr->codec_ptr = avcodec_find_decoder(CODEC_ID_H264);
    ...
    DBG("FFMPEG H.264 decode init complete\n");
    return (0);
...
#endif
    DBG("FFMPEG H.264 decode shut down complete\n");
