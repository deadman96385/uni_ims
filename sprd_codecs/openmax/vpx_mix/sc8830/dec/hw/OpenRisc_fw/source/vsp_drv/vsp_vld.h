...
#define HVLD_CTX_BIN0_CAT5_OFFSET			0x7c
#define HVLD_CTX_BINOTH_CAT5_OFFSET			0x80
#define HVLD_CTX_BIN0_INC4_CAT5_OFFSET		0x84
#define HVLD_CTX_BINOTH_INC4_CAT5_OFFSET	0x85
#endif
...
#ifdef LUMA_8x8_CABAC
	volatile uint32		ctx_bin0_cat5;		//[6:0]: context for inc0	6: mps, [5:0]: state 
											//[14:8]: context for inc1	6: mps, [5:0]: state 
											//[22:16]: context for inc2	6: mps, [5:0]: state 
											//[30:24]: context for inc3	6: mps, [5:0]: state 

	volatile uint32		ctx_binoth_cat5;		//[6:0]: context for inc0	6: mps, [5:0]: state 
												//[14:8]: context for inc1	6: mps, [5:0]: state 
												//[22:16]: context for inc2	6: mps, [5:0]: state 
												//[30:24]: context for inc3	6: mps, [5:0]: state 

	volatile uint32		ctx_bin0_binoth_inc4_cat5;		//[6:0]: context for bin0 inc4	6: mps, [5:0]: state 												
														//[14:8]: context for binoth inc4	6: mps, [5:0]: state 											
#endif
}VSP_HVLD_REG_T;
