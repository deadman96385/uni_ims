...
#undef LOG_TAG
#define LOG_TAG "PVRTSPEngineNode"
...
PVMFStatus PVRTSPEngineNode::DoPrepareNode(PVRTSPEngineCommand &aCmd)
{
    ...
    else  //zhagjl remove for live because servr suport iPipelining not completly
#endif  		
    {
        ...
        int32& aEventCode)
{
	...
	LOGE("PVRTSPEngineNode::MapRTSPCodeToEventCode aStatusCode %d",aStatusCode);
	switch (aStatusCode)
    {
        case 202:
            //"202"      ; Accepted
