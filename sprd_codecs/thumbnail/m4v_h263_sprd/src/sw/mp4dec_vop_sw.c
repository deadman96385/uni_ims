 ...
 **	Note:
 *****************************************************************************/
PUBLIC MMDecRet Mp4Dec_DecIVOP_sw(VIDEO_DATA_T *vd, DEC_VOP_MODE_T *vop_mode_ptr)
{
	int32 pos_y, pos_x;
...
#endif
PUBLIC MMDecRet Mp4Dec_DecPVOP_sw(VIDEO_DATA_T *vd, DEC_VOP_MODE_T *vop_mode_ptr)
{
	int32 pos_y, pos_x;
	DEC_MB_MODE_T * mb_mode_ptr = vop_mode_ptr->pMbMode;
	DEC_MB_BFR_T  * mb_cache_ptr = vop_mode_ptr->mb_cache_ptr;
 ...
 **	Note:
 *****************************************************************************/
PUBLIC MMDecRet Mp4Dec_DecBVOP_sw(VIDEO_DATA_T *vd, DEC_VOP_MODE_T *vop_mode_ptr)
{
	MMDecRet ret = MMDEC_OK;
#if 0
	int32 pos_y, pos_x;
