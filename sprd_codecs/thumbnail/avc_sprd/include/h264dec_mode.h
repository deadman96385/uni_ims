...
typedef void (*direct_mv_func) (void *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr);
typedef int8 (*pred_skip_bslice_func) (void *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr);
...
typedef uint32 (*readB8_typeInfo_func) (void *img_ptr, DEC_MB_CACHE_T *mb_cache_ptr, int32 blk8x8Nr);
...
//hw	
	...
	FunctionType_Bind_CB avc_bindCb;
	FunctionType_UnBind_CB avc_unbindCb;
	void *avc_user_data;
