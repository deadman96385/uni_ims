...
//    OR1200_WRITE_REG(0x180014, (0x12340000|nal_ptr->nal_unit_type),"for FPGA debug 5");
	...
	//OR1200_WRITE_REG(0x8038000c, nal_ptr->nal_unit_type,"for FPGA debug 1");
  ...
  //OR1200_WRITE_REG(0x80380010, 0x12345678,"for FPGA debug 1");
	return ret;
}
...
PUBLIC void H264Dec_FirstPartOfSliceHeader (DEC_SLICE_T *curr_slice_ptr, DEC_IMAGE_PARAMS_T *img_ptr)
{
	...
	//OR1200_WRITE_REG(0x80380014, curr_slice_ptr->start_mb_nr|0x12340000,"for FPGA debug 1");
