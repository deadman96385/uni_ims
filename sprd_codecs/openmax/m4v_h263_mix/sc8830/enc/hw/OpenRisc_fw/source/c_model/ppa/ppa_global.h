...
extern int32 g_wp_weight[2][16][3];  // weight in [list][index][component] order
extern int32 g_wp_offset[2][16][3];  // offset in [list][index][component] order
