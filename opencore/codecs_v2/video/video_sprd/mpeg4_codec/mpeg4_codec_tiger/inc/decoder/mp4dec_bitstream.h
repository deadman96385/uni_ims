...
PUBLIC uint32 Mp4Dec_ByteAlign_Mp4(DEC_BS_T *bs_ptr);
PUBLIC uint32 Mp4Dec_ReadBits(DEC_BS_T *bs_ptr, uint32 nbits);
PUBLIC uint32 Mp4Dec_ShowBitsByteAlign(DEC_BS_T *bs_ptr, int32 nbits);
PUBLIC uint32 Mp4Dec_ByteAlign_Startcode(DEC_BS_T *bs_ptr);
PUBLIC uint32 Mp4Dec_ShowBitsByteAlign_H263(DEC_BS_T *bs_ptr, int32 nbits);

PUBLIC void Mp4Dec_InitBitstream_sw(DEC_BS_T *bitstream_ptr, void *pOneFrameBitstream, int32 length);
