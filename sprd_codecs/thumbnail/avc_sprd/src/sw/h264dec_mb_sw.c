...
LOCAL void H264Dec_read_and_derive_ipred_modes_sw(H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
...
LOCAL void H264Dec_read_intraMB_context_sw (H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
...
//LOGI("%s, %d,[%d,%d]", __FUNCTION__, __LINE__, img_ptr->mb_x, img_ptr->mb_y);
