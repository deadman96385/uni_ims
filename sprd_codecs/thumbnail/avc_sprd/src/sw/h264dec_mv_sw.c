...
LOCAL void H264Dec_Config_WP_info_sw(H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
#ifdef WIN32
	uint32 row, col;
	int32 blk4x4_id;	
...
void H264Dec_Config_8x8MC_info_sw(H264DecContext *img_ptr, DEC_MB_CACHE_T *mb_cache_ptr, int32 b8, int32 b8pdir)
{
...
void H264Dec_Config_4x4MC_info_sw(H264DecContext *img_ptr, DEC_MB_CACHE_T *mb_cache_ptr, int32 b8, int32 b8pdir)
{
	uint32 b4;
	uint32 b8_cache_offset;
...
PUBLIC int8 H264Dec_mv_prediction_skipped_bslice_spatial_sw (void *img, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
...
PUBLIC int8 H264Dec_mv_prediction_skipped_bslice_temporal_sw (void *img, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
	H264DecContext *img_ptr = (H264DecContext *)img;
	int32 use_8x8mc;
	int32 use_4x4mc[4] = {0, 0, 0, 0};
...
//	H264DecContext *img_ptr = g_image_ptr;
	uint8 **pRefFrame;
	DEC_STORABLE_PICTURE_T ** list;
//	int32 pdir = mb_cache_ptr->b8pdir[0];
	int32 s_list;
