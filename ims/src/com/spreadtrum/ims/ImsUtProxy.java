...
public class ImsUtProxy extends IImsUt.Stub {
    ...
    private com.spreadtrum.ims.ImsUtImpl mVoLTEUtImpl;
    ...
    public ImsUtProxy(Context context, com.spreadtrum.ims.ImsUtImpl VoLTEUtImpl,
    ...
    public void setListener(IImsUtListener listener) {
        mListener = listener;
        TelephonyManager tm = TelephonyManager.getDefault(mPhone.getPhoneId());
    ...
    private void getUTConfig(String carrier) {
        ...
        if (carrierConfig != null) {
            ...
            if (config != null){
                ...
                queryOnVoLTEPlmns = config.getString(
                        CarrierConfigManager.KEY_UT_FALLBACK_VOLTE, "");
            }
    ...
    private final IImsUtListener.Stub mImsUtListener = new IImsUtListener.Stub() {
        ...
        public void utConfigurationCallBarringFailed(int id, int[] result, int errorCode) {
            if (id > VOWIFI_QUERY_ID && mQueryOnVoLTE) {
                ...
                try {
                    mListener.utConfigurationCallBarringFailed(id, result, errorCode);
                    mPendingMap.remove(id);
                } catch (RemoteException e) {
                    e.printStackTrace();
                }
        ...
        public void utConfigurationCallBarringResult(int id, int[] result) {
            ...
            try {
                mListener.utConfigurationCallBarringResult(id, result);
                mPendingMap.remove(id);
            } catch (RemoteException e) {
                e.printStackTrace();
            }
        ...
        @Override
        public void utConfigurationCallForwardQueriedEx(IImsUt ut,
            ...
            try {
                mListener.utConfigurationCallForwardQueriedEx(ut, id, cfInfo);
                mPendingMap.remove(id);
            } catch (RemoteException e) {
                e.printStackTrace();
            }
