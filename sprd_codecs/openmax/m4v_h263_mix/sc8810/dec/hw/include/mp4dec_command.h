...
void Mp4Dec_init_frame_VSP(MP4DecObject *vd, DEC_VOP_MODE_T *vop_mode_ptr, MMDecInput *dec_input_ptr);
...
MMDecRet Mp4Dec_VspFrameInit(MP4DecObject *vd, DEC_VOP_MODE_T *vop_mode_ptr, uint32 bitstm_addr);
