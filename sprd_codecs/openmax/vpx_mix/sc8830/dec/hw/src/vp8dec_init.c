...
void Vp8Dec_InitVSP(VPXDecObject *vo)
{
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x24, cmd, "ORSC: IMG_SIZE: Set MB_X_MAX & MB_Y_MAX");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x44, cmd, "ORSC: VSP_CFG2");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x48, cmd, "ORSC: VSP_CFG3");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x4C, cmd, "ORSC: VSP_CFG4");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x50, cmd, "ORSC: VSP_CFG5");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x54, cmd, "ORSC: VSP_CFG6");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x58, cmd, "ORSC: VSP_CFG7");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x5C, cmd, "ORSC: VSP_CFG8");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x68, cmd, "ORSC: ADDR_IDX_CFG0, QP_DC_0");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x6C, cmd, "ORSC: ADDR_IDX_CFG1, QP_AC_0");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x70, cmd, "ORSC: ADDR_IDX_CFG2, QP_DC_1");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x74, cmd, "ORSC: ADDR_IDX_CFG3, QP_AC_1");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x78, cmd, "ORSC: ADDR_IDX_CFG4, QP_DC_2");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x7C, cmd, "ORSC: ADDR_IDX_CFG5, QP_AC_2");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x84, cmd, "ORSC: VSP_CFG9, QP_DC_3");
    ...
    VSP_WRITE_REG(GLB_REG_BASE_ADDR + 0x88, cmd, "ORSC: VSP_CFG10, QP_AC_3");

    cmd = 0;	// List0_POC[0][31:0]
    VSP_WRITE_REG(PPA_SLICE_INFO_BASE_ADDR + 0x0, cmd, "ORSC: List0_POC[0]");

    VSP_WRITE_REG(FRAME_ADDR_TABLE_BASE_ADDR + 0x0, ((uint32)pc->new_frame.y_buffer) >> 3, "ORSC: Frm_addr0: Start address of reconstruct frame Y");
    VSP_WRITE_REG(FRAME_ADDR_TABLE_BASE_ADDR + 0x4, ((uint32)pc->new_frame.u_buffer) >> 3, "ORSC: Frm_addr1: Start address of reconstruct frame UV");
    VSP_WRITE_REG(FRAME_ADDR_TABLE_BASE_ADDR + 0x10, ((uint32)Vp8Dec_InterMem_V2P(vo, pc->FRAME_ADDR_4)) >> 3, "ORSC: Frm_addr4: Partition info for MB Header");
    if(pc->frame_type != KEY_FRAME)
    {
        VSP_WRITE_REG(FRAME_ADDR_TABLE_BASE_ADDR + 0x80, ((uint32)pc->last_frame.y_buffer) >> 3, "ORSC: Frm_addr32: Start address of Reference list0 frame Y(last)");
        VSP_WRITE_REG(FRAME_ADDR_TABLE_BASE_ADDR + 0x100, ((uint32)pc->last_frame.u_buffer) >> 3, "ORSC: Frm_addr64: Start address of Reference list0 frame UV(last)");
        VSP_WRITE_REG(FRAME_ADDR_TABLE_BASE_ADDR + 0x84, ((uint32)pc->golden_frame.y_buffer) >> 3, "ORSC: Frm_addr33: Start address of Reference list0 frame Y(golden)");
        VSP_WRITE_REG(FRAME_ADDR_TABLE_BASE_ADDR + 0x104, ((uint32)pc->golden_frame.u_buffer) >> 3, "ORSC: Frm_addr65: Start address of Reference list0 frame UV(golden)");
        VSP_WRITE_REG(FRAME_ADDR_TABLE_BASE_ADDR + 0x88, ((uint32)pc->alt_ref_frame.y_buffer) >> 3, "ORSC: Frm_addr34: Start address of Reference list0 frame Y(alt_ref)");
        VSP_WRITE_REG(FRAME_ADDR_TABLE_BASE_ADDR + 0x108, ((uint32)pc->alt_ref_frame.u_buffer) >> 3, "ORSC: Frm_addr66: Start address of Reference list0 frame UV(alt_ref)");
    }
}
...
uint32 BitstreamReadBits (VPXDecObject *vo, uint32 nbits)
{
    ...
    cmd = (uint32)VSP_READ_REG(BSM_CTRL_REG_BASE_ADDR+0x10, "ORSC: BSM_RDATA");
    VSP_WRITE_REG(BSM_CTRL_REG_BASE_ADDR+0x08, (((nbits)&0x3f)<<24)|0x1, "ORSC: BSM_OPERATE: BSM_FLUSH n bits");
...
void Write_tbuf_Probs(VPXDecObject *vo)
{
    ...
    VSP_WRITE_REG(VLC_TABLE0_BASE_ADDR + 4*word_addr++, cmd, "ORSC: Write VLC table0");
    ...
    VSP_WRITE_REG(VLC_TABLE0_BASE_ADDR + 4*word_addr++, (0x0000009F), "ORSC: Write VLC table0");	// Pcat1
    VSP_WRITE_REG(VLC_TABLE0_BASE_ADDR + 4*word_addr++, (0x000091A5), "ORSC: Write VLC table0");	// Pcat2
    VSP_WRITE_REG(VLC_TABLE0_BASE_ADDR + 4*word_addr++, (0x008C94AD), "ORSC: Write VLC table0");	// Pcat3
    VSP_WRITE_REG(VLC_TABLE0_BASE_ADDR + 4*word_addr++, (0x878C9BB0), "ORSC: Write VLC table0");	// Pcat4
    VSP_WRITE_REG(VLC_TABLE0_BASE_ADDR + 4*word_addr++, (0x00000000), "ORSC: Write VLC table0");	// Pcat4
    VSP_WRITE_REG(VLC_TABLE0_BASE_ADDR + 4*word_addr++, (0x868D9DB4), "ORSC: Write VLC table0");	// Pcat5
    VSP_WRITE_REG(VLC_TABLE0_BASE_ADDR + 4*word_addr++, (0x00000082), "ORSC: Write VLC table0");	// Pcat5
    VSP_WRITE_REG(VLC_TABLE0_BASE_ADDR + 4*word_addr++, (0xE6F3FEFE), "ORSC: Write VLC table0");	// Pcat6
    VSP_WRITE_REG(VLC_TABLE0_BASE_ADDR + 4*word_addr++, (0x8C99B1C4), "ORSC: Write VLC table0");	// Pcat6
    VSP_WRITE_REG(VLC_TABLE0_BASE_ADDR + 4*word_addr++, (0x00818285), "ORSC: Write VLC table0");	// Pcat6
    VSP_WRITE_REG(VLC_TABLE0_BASE_ADDR + 4*word_addr++, (vo->g_fh_reg_ptr->FH_CFG8), "ORSC: Write VLC table0");
}
