...
H264Dec_extent_frame:	@FUNCTION
		...
		@//horizontal repeat
			@//y
			ldrh	r14, [img_ptr, #24]	@//img_ptr->start_in_frameY
...
loop_uv_0:			
			ldrh	r14, [img_ptr, #26]		@//img_ptr->start_in_frameUV
			add		pSrc1, pSrc1, r14
