...
false: sign failed
*/
bool RSA_PrvEnc( unsigned char* prvExp, unsigned char* mod_N,int  bitLen_N, unsigned char *from,int flen, unsigned char*to );
/*
...
*/
bool RSA_PubEnc( unsigned char* pubExp, unsigned char* mod_N,int  bitLen_N, unsigned char *from,int flen, unsigned char*to );
/*
