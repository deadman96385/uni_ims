...
#endif
//	FPRINTF_DBK (g_fp_dbk_info_tv, "//p3=%2x, p2=%2x, p1=%2x, p0=%2x, q0=%2x, q1=%2x, q2=%2x, q3=%2x\n", p3&0xff, p2&0xff, p1&0xff, p0&0xff, q0&0xff, q1&0xff, q2&0xff, q3&0xff);
#endif
	...
	if(g_nFrame_dec==FRAME_X)
#endif
//		FPRINTF_DBK (g_fp_dbk_info_tv, "//p2_f=%x, p1_f=%x, p0_f=%x, q0_f=%x, q1_f=%x, q2_f=%x\n", p2_f, p1_f, p0_f, q0_f, q1_f, q2_f);
#endif
	...
	if(g_nFrame_dec==FRAME_X)
#endif
//		FPRINTF_DBK (g_fp_dbk_info_tv, "//p2_upt=%x, p1_upt=%x, p0_upt=%x, q0_upt=%x, q1_upt=%x, q2_upt=%x\n", p2_upt, p1_upt, p0_upt, q0_upt, q1_upt, q2_upt);
#endif
