...
import com.sprd.security.tools.network.database.DataSupport;
import com.sprd.security.tools.network.database.MyDatePickerDialog;
...
public class Showmain extends Activity {
	...
	public static final String RX3G = "3gDownloadData";
	public static final String TX3G = "3gUploadData";
	public static final String RXT = "AllDownloadData";
	public static final String TXT = "ALlUploadData";
	...
	private void search_result() {
		...
		Cursor t3gshutdown = minsert.selectbetweenday(TX3G, SHUTDOWN,
				startdate, overdate);
		liuliangzongbiaoti.setText(startdate + "to" + overdate + "data");
		if (r3gst.moveToNext()) {
