...
H264E_COMMON_INC=${SRC}/h264_encoder/code/inc/common/
H264E_ENC_INC=${SRC}/h264_encoder/code/inc/encoder/
# Source Code
ORSC_SRC=${SRC}/openrisc/src/*.c
ORSC_ROM= #./openrisc/src/*.S
H264E_ENC_SRC=${SRC}/h264_encoder/code/src/encoder/*.c
H264E_MAIN=${SRC}/h264_encoder/simulation/vc/WinPrj/h264enc_main.c
MAIN=${SRC}/main.c
