...
@//void MC_luma16xN_dx0dy0 (uint8 * pRefFrame, uint8 * pPred, int32 width, int32 N)
...
@//void MC_luma16xN_dxMdy0 (uint8 * pRefFrame, uint8 * pPred, int32 width, int32 N)
...
@//only for dx=2, dy=0
@//void MC_luma16xN_yfull (uint8 * pRefFrame, uint8 * pPred, int32 width, int32 N)
...
@//void MC_luma16xN_dx0dyM (uint8 * pRefFrame, uint8 * pPred, int32 width, int32 N)
...
@//void MC_luma16xN_xyqpix (uint8 * pRefFrame, uint8 * pPred, int32 width, int32 N)
...
@//void MC_luma16xN_xhalf (uint8 * pRefFrame, uint8 * pPred, int32 width, int32 N)
...
@//void MC_luma16xN_yhalf (uint8 * pRefFrame, uint8 * pPred, int32 width, int32 N)
