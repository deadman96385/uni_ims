...
//#else
	...
	g_vector_enable_flag = 0;//0x1df7;//0;
//#endif
...
FILE *g_fp_global_tv;//james
FILE *g_fp_mea_mb_ime_tv;//james
FILE *g_fp_mea_mca_mb_tv;//james
FILE *g_fp_mea_mb_tv;//james
FILE *g_fp_mea_ref_frm_y_tv;//james
FILE *g_fp_mea_ref_frm_u_tv;//james
FILE *g_fp_mea_ppa_buf_tv;//james
FILE *g_fp_mea_cfg_tv;//james
FILE *g_fp_ime_mb_sad_tv;//james
FILE *g_fp_fme_mb_sad_tv;//james
FILE *g_fp_ime_best_sad_tv;//james
FILE *g_fp_fme_best_sad_tv;//james
FILE *g_fp_frame_cfg;//james
FILE *g_fp_mvlc_cfg;//james

//iea
FILE *g_fp_iea_src_mb_tv;//james
FILE *g_fp_iea_in_tv;//james
//FILE *g_fp_iea_out_tv;//james
//ppa
FILE *g_fp_vlc_para_tv;//james
FILE *g_fp_dct_para_tv;//james
FILE *g_fp_ppa_cfg_tv;//james
FILE *g_fp_ppa_in_tv;//james
FILE *g_fp_mbc_para_tv;//james
FILE *g_fp_cbp_in_tv;//james
//dct
FILE *g_fp_huff_tab_tv;//james
FILE *g_fp_dct_out_tv;//james

//mbc
FILE *g_fp_mbc_dct_out_tv;
FILE *g_fp_mbc_idct_in_tv;

FILE *g_fp_mbc_tv;
FILE *g_fp_bsm_tv;
FILE *g_fp_bsm_total_bits_tv;
FILE *g_fp_rec_frm_tv;
FILE *g_fp_idct_tv;
FILE *g_fp_vld_tv;
FILE *g_fp_rec_frmy_tv;//jzy
FILE *g_fp_rec_frmuv_tv;
FILE *g_fp_parser_tv;//weihu
FILE *g_fp_global_tv;//weihu
FILE *g_fp_dctpara_tv;
FILE *g_fp_mbcpara_tv;
FILE *g_fp_dbkpara_tv;
FILE *g_fp_mcapara_tv;
FILE *g_fp_iquant_tv;
FILE *g_fp_hadarm_tv;
FILE *g_fp_psi_tv;//jzy
FILE *g_fp_iqw_tv;//jzy
FILE *g_fp_colin_tv;//jzy
FILE *g_fp_colout_tv;//jzy
FILE *g_fp_mcain_luma_tv;//jzy
FILE *g_fp_mcain_chroma_tv;//jzy
FILE *g_fp_wpin_tv;
FILE *g_fp_wpwt_tv;//jzy,weight
//FILE *g_fp_wpwt1_tv;//jzy,weight
FILE *g_fp_wpst_tv;//jzy,shift
FILE *g_fp_wprt_tv;//jzy,result
FILE *g_fp_mbc_ipred;//jzy,intra&inter
FILE *g_fp_mbc_idctin;
//////////////////////////////////////////////////////////////////////////
//  TRACE FILES
//////////////////////////////////////////////////////////////////////////
...
FILE *g_fp_slicedata_offset;//weihu
FILE *g_fp_MBtype;//weihu
FILE *g_fp_global;//weihu
FILE *g_fp_vld_global;//weihu
FILE *g_fp_trace_mcaflt;
