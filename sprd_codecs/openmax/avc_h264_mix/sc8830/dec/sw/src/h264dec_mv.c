...
PUBLIC int32 decode_cavlc_mb_mvd(H264DecContext *img_ptr, DEC_MB_CACHE_T *mb_cache_ptr, int32 sub_blk_id, int32 list)
{
...
LOCAL void H264Dec_read_motionAndRefId_PMB16x16 (H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
...
LOCAL void H264Dec_read_motionAndRefId_PMB16x8 (H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
    DEC_STORABLE_PICTURE_T	**listX;
    int32 ref_frm_id_s32;
    uint32 b16x8;
...
LOCAL void H264Dec_read_motionAndRefId_PMB8x16 (H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
    DEC_STORABLE_PICTURE_T	**listX;
    int32 ref_frm_id_s32;
    uint32 b8x16;
...
LOCAL void H264Dec_read_motionAndRefId_P8x8 (H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
    DEC_STORABLE_PICTURE_T	**listX;
    int32 ref_frm_id_s32;
...
//not reference
void H264Dec_FillNoRefList_8x8(H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, uint32 b8, int32 b8pdir)
{
...
PUBLIC void H264Dec_mv_prediction_P8x8 (H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
    uint32 i;
    int8  *ref_idx_ptr[2];
    int32 b8mode;
    ...
    if (b8mode != 0)
    {
        b8pdir = (*img_ptr->b8_mv_pred_func[b8mode-4])(img_ptr, mb_info_ptr, mb_cache_ptr, cache_offset, 0);
    } else
    {
        b8pdir = MC8x8_direct(mb_info_ptr, mb_cache_ptr, 0,  cache_offset);
    }
#else
    b8pdir = (*img_ptr->b8_mv_pred_func[b8mode])((void *)img_ptr, mb_info_ptr, mb_cache_ptr, cache_offset, 0);
#endif

    if ((img_ptr->type == B_SLICE) && (b8pdir != 2))
    {
        H264Dec_FillNoRefList_8x8(img_ptr, mb_info_ptr, 0, b8pdir);
    }
    ...
    if (b8mode != 0)
    {
        b8pdir = (*img_ptr->b8_mv_pred_func[b8mode-4])(img_ptr, mb_info_ptr, mb_cache_ptr, cache_offset, 1);
    } else
    {
        b8pdir = MC8x8_direct(mb_info_ptr, mb_cache_ptr, 1,  cache_offset);
    }
#else
    b8pdir = (*img_ptr->b8_mv_pred_func[b8mode])((void *)img_ptr, mb_info_ptr, mb_cache_ptr, cache_offset, 1);
#endif

    if ((img_ptr->type == B_SLICE) && (b8pdir != 2))
    {
        H264Dec_FillNoRefList_8x8(img_ptr, mb_info_ptr, 1, b8pdir);
    }
    ...
    if (b8mode != 0)
    {
        b8pdir = (*img_ptr->b8_mv_pred_func[b8mode-4])(img_ptr, mb_info_ptr, mb_cache_ptr, cache_offset, 2);
    } else
    {
        b8pdir = MC8x8_direct(mb_info_ptr, mb_cache_ptr, 2,  cache_offset);
    }
#else
    b8pdir = (*img_ptr->b8_mv_pred_func[b8mode])((void *)img_ptr, mb_info_ptr, mb_cache_ptr, cache_offset, 2);
#endif

    if ((img_ptr->type == B_SLICE) && (b8pdir != 2))
    {
        H264Dec_FillNoRefList_8x8(img_ptr, mb_info_ptr, 2, b8pdir);
    }
    ...
    if (b8mode != 0)
    {
        b8pdir = (*img_ptr->b8_mv_pred_func[b8mode-4])(img_ptr, mb_info_ptr, mb_cache_ptr, cache_offset, 3);
    } else
    {
        b8pdir = MC8x8_direct(mb_info_ptr, mb_cache_ptr, 3,  cache_offset);
    }
#else
    b8pdir = (*img_ptr->b8_mv_pred_func[b8mode])((void *)img_ptr, mb_info_ptr, mb_cache_ptr, cache_offset, 3);
#endif

    if ((img_ptr->type == B_SLICE) && (b8pdir != 2))
    {
        H264Dec_FillNoRefList_8x8(img_ptr, mb_info_ptr, 3, b8pdir);
    }
...
PUBLIC void H264Dec_direct_mv_spatial(void *img, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
    H264DecContext *img_ptr = (H264DecContext *)img;
...
PUBLIC void H264Dec_direct_mv_temporal(void *img, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
    H264DecContext *img_ptr = (H264DecContext *)img;
    DEC_STORABLE_PICTURE_T	*fs = img_ptr->g_list[1][0];
    ...
    for (i = 0; i < iref_max; i++)
    {
        ...
        iTRb = Clip3( -128, 127, (img_ptr->g_dec_picture_ptr->poc - g_list[0][i]->poc ));
...
PUBLIC int8 H264Dec_mv_prediction_skipped_bslice_spatial (void *img, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
    H264DecContext *img_ptr = (H264DecContext *)img;
    int32 mv_xy;
    int32 use_8x8mc;
...
PUBLIC int8 H264Dec_mv_prediction_skipped_bslice_temporal (void *img, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
    H264DecContext *img_ptr = (H264DecContext *)img;
    int32 use_8x8mc;
    int32 use_4x4mc[4] = {0, 0, 0, 0};
...
LOCAL void H264Dec_mv_prediction_skipped_pslice_sw (H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
    int32 pred_mv;
    int32 mv_xy;
    int32 mv_x, mv_y;
...
LOCAL void H264Dec_mv_prediction_PMB16x16_sw (H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
...
LOCAL void H264Dec_mv_prediction_PMB16x8_sw (H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
    int32 pred_mv_x, pred_mv_y, pred_mv_xy;
    int32 mvd_x, mvd_y;
    int32 mv_x, mv_y;
...
LOCAL void H264Dec_mv_prediction_PMB8x16_sw (H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
    int32 pred_mv_x, pred_mv_y, pred_mv_xy;
    int32 mvd_x, mvd_y;
    int32 mv_x, mv_y;
...
PUBLIC int32 H264Dec_mv_prediction_P8x8_8x8 (void *img, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr, int32 cache_offset, int32 b8)
{
    H264DecContext *img_ptr = (H264DecContext *)img;
    int32 pred_mv_x, pred_mv_y, pred_mv_xy;
    int32 mvd_x, mvd_y;
...
PUBLIC int32 H264Dec_mv_prediction_P8x8_8x4 (void *img, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr, int32 cache_offset, int32 b8)
{
    H264DecContext *img_ptr = (H264DecContext *)img;
    int32 pred_mv_x, pred_mv_y, pred_mv_xy;
    int32 mvd_x, mvd_y;
...
PUBLIC int32 H264Dec_mv_prediction_P8x8_4x8 (void *img, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr, int32 cache_offset, int32 b8)
{
    H264DecContext *img_ptr = (H264DecContext *)img;
    int32 pred_mv_x, pred_mv_y, pred_mv_xy;
    int32 mvd_x, mvd_y;
...
PUBLIC int32 H264Dec_mv_prediction_P8x8_4x4 (void *img, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr, int32 cache_offset, int32 b8)
{
    H264DecContext *img_ptr = (H264DecContext *)img;
    int32 pred_mv_x, pred_mv_y, pred_mv_xy;
    int32 mvd_x, mvd_y;
...
PUBLIC int32 H264Dec_MC8x8_direct_spatial(void *img, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr, int32 cache_offset, int32 b8)
{
    H264DecContext *img_ptr = (H264DecContext *)img;
    int32 fw_rFrame,bw_rFrame;
    int32 mv_xy;
...
PUBLIC int32 H264Dec_MC8x8_direct_temporal(void *img, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr, int32 cache_offset, int32 b8)
{
    H264DecContext *img_ptr = (H264DecContext *)img;
    uint32 use_4x4mc = 0;
    uint32 b8pdir = 0;
...
PUBLIC void H264Dec_mv_prediction (H264DecContext *img_ptr, DEC_MB_INFO_T *mb_info_ptr, DEC_MB_CACHE_T *mb_cache_ptr)
{
    if (mb_cache_ptr->is_skipped || mb_info_ptr->mb_type == 0)
    {
        ...
        {
            b8pdir = img_ptr->pred_skip_bslice ((void *)img_ptr, mb_info_ptr, mb_cache_ptr);
