#ifndef _SRIL_SVCMODE_H
#define _SRIL_SVCMODE_H
...
typedef enum {
  ...
  SVC_MODE_WB_AMR_SETTING,          /*+20120730 WBAMR */
  SVC_MODE_R6_DWGRADE,              /*+20121018 R6_DWGRADE */
  SVC_MODE_MAX
} svc_mode_type;
...
/* If Service mode is SVC_MODE_R6_DWGRADE */
typedef enum {
	SVC_DWGRADE_SET = 0x00,
	SVC_DWGRADE_GET
} svc_downgrade_sub_type;

// for Svcmode display
typedef struct {
	unsigned char 	line;
	unsigned char	reverse;
	char			string[MAX_SVCSTR_PER_LINE];
} OemSvcModeRsp;
