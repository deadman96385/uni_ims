 ...
 **	Note:
 *****************************************************************************/
PUBLIC void Mp4Dec_DecSecondPartitionIntraErrRes_vt(DEC_VOP_MODE_T *vop_mode_ptr, int32 start_mb_no)
{
 ...
 **	Note:
 *****************************************************************************/
PUBLIC void Mp4Dec_DecSecondPartitionInterErrRes_vt(DEC_VOP_MODE_T *vop_mode_ptr, int32 start_mb_no)
{
	int32 mb_num = start_mb_no;
	DEC_MB_MODE_T *mb_mode_ptr = PNULL;
	DEC_MB_BFR_T* mb_cache_ptr = vop_mode_ptr->mb_cache_ptr;
	...
	while(mb_num < (vop_mode_ptr->mbnumDec))
	{
		...
		{
			Mp4Dec_DecInterMBTexture_DP_vt(vop_mode_ptr, mb_mode_ptr, mb_cache_ptr);				
		}
