...
PUBLIC MMDecRet Mp4Dec_DecH263Header(DEC_VOP_MODE_T *vop_mode_ptr,SLICEINFO SliceInfo);
...
PUBLIC  MMDecRet Mp4Dec_DecGobHeader(DEC_VOP_MODE_T *vop_mode_ptr,SLICEINFO *SliceInfo);
MMDecRet Mp4Dec_GetVideoPacketHeader(DEC_VOP_MODE_T *vop_mode_ptr,SLICEINFO *SliceInfo, uint32 uAddBits);
PUBLIC BOOLEAN Mp4Dec_CheckResyncMarker(uint32 uAddbit);
PUBLIC BOOLEAN Mp4Dec_DetectResyncMarker(uint32 uAddbit); //czzheng
