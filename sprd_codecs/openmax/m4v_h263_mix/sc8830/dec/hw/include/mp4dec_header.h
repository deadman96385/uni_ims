...
MMDecRet Mp4Dec_GetVideoPacketHeader(Mp4DecObject *vo, uint32 uAddBits);
BOOLEAN Mp4Dec_CheckResyncMarker(Mp4DecObject *vo, uint32 uAddbit);
BOOLEAN Mp4Dec_DetectResyncMarker(Mp4DecObject *vo, uint32 uAddbit); //czzheng
