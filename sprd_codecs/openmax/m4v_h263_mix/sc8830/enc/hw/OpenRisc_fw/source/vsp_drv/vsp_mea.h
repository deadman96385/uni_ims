...
typedef struct mea_control_tag
{
	volatile uint32 MEA_CFG0;			//[31:25]: reserved
										...
										//---james: add search range
										//[15:8]: search_rangeY -- size of search window. maxium 63 pixels in vertical component.
										//[7:0]:search_rangeX -- size of search window. maxium 63 pixels in horizontal component. 
										//-------------------------------
	...
	volatile uint32 mea_result_imv;	//james integer pixel mv
										//[31:29]: reserved
										//[15:8]: mea_y_mv -- the initial search motion vector in Y direction
										//[7:0]: mea_x_mv -- the initial search motion vector in X direction;
}VSP_MEA_REG_T;
