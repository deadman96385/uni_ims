...
MMDecRet Mp4Dec_DecIVOP_vt(DEC_VOP_MODE_T *vop_mode_ptr);
MMDecRet Mp4Dec_DecPVOP_vt(DEC_VOP_MODE_T *vop_mode_ptr);
 MMDecRet Mp4Dec_DecBVOP_vt(DEC_VOP_MODE_T * vop_mode_ptr);
