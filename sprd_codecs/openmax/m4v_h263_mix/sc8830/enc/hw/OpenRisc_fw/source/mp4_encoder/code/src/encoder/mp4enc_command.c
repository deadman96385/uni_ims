...
void Mp4Enc_ConfigVLC(ENC_VOP_MODE_T *pVop_mode, ENC_MB_MODE_T *pMb_mode)
{
	...
	PrintfVLCCFG(pVop_mode, pMb_mode);
#endif
...
{
#ifdef SIM_IN_WIN
// 	READ_REG_POLL(VSP_MBC_REG_BASE+MBC_ST0_OFF, V_BIT_5, V_BIT_5, TIME_OUT_CLK, "MBC: polling mbc done, the last mb of current frame");
