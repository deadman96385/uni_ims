 ...
 **	Note:
 *****************************************************************************/
PUBLIC void Mp4Dec_DecIntraMBTexture_hw(MP4DecObject *vd, DEC_VOP_MODE_T *vop_mode_ptr, DEC_MB_MODE_T *mb_mode_ptr)
{
	...
	{
		vd->g_Mp4Dec_GetIntraBlkTCoef_hw(vop_mode_ptr, mb_mode_ptr, blk_num);
 ...
 **	Note:
 *****************************************************************************/
PUBLIC void Mp4Dec_DecInterMBTexture_hw(MP4DecObject *vd, DEC_VOP_MODE_T *vop_mode_ptr, DEC_MB_MODE_T *mb_mode_ptr)
{
	int32 iBlkIdx;
