...
PUBLIC void H264Dec_init_img_buffer (DEC_IMAGE_PARAMS_T *img_ptr)
{
	...
	if (img_ptr->VSP_used)
	{
		...
		img_ptr->frame_bistrm_buf[0] = (uint8 *)H264Dec_ExtraMemAlloc (H264DEC_FRM_STRM_BUF_SIZE);
		img_ptr->frame_bistrm_buf[1] = (uint8 *)H264Dec_ExtraMemAlloc (H264DEC_FRM_STRM_BUF_SIZE);
