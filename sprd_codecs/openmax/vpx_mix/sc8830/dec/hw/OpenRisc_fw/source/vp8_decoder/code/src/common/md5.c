...
void Get_MD5_Code(uint8 *img, uint32 datalen, uint8 *code)
{
	...
	code[0] = A & 0xff; code[1] = (A >>8) & 0xff; code[2] = (A >>16) & 0xff; code[3] = (A >>24) &0xff;
	code[4] = B & 0xff; code[5] = (B >>8) & 0xff; code[6] = (B >>16) & 0xff; code[7] = (B >>24) &0xff;
	code[8] = C & 0xff; code[9] = (C >>8) & 0xff; code[10]= (C >>16) & 0xff; code[11]= (C >>24) &0xff;
	code[12]= D & 0xff; code[13]= (D >>8) & 0xff; code[14]= (D >>16) & 0xff; code[15]= (D >>24) &0xff;
}
