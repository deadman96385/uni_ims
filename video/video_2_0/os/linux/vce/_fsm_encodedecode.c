...
static const char _stateName[] = "Codec:encodedecode";
/*
 * ======== _processEvent ========
...
static void _processEvent(
    ...
    char           *eventDesc_ptr)
{
    FSM_State_Ptr  nextState_ptr = (FSM_State_Ptr)&_FSM_STATE_ENCODEDECODE;
 ...
 */
const FSM_State _FSM_STATE_ENCODEDECODE = {
