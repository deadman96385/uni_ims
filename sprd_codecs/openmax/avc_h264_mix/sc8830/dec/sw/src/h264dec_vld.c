...
/**
  ...
  */
int readCoeff4x4_CAVLC (H264DecContext *img_ptr, DEC_MB_CACHE_T *mb_cache_ptr, int16 *block, int32 n, const uint8 *scantable, const uint32 *qmul, int32 max_coeff)
{
...
void decode_CHROMA_AC (H264DecContext *img_ptr, DEC_MB_INFO_T * currMB, DEC_MB_CACHE_T * mb_cache_ptr, int qp_uv[2])
{
    int uv;
    int numCoeff;
    int blkIndex;
...
static int32 readCoeff4x4_CABAC(void *img, DEC_MB_INFO_T * currMB, DEC_MB_CACHE_T *mb_cache_ptr, int16 *block, int cat, int32 n, const uint8 *scantable, const uint32 *qmul, int32 max_coeff)
{
...
void decode_LUMA_AC_cabac (H264DecContext *img_ptr, DEC_MB_INFO_T * currMB, DEC_MB_CACHE_T * mb_cache_ptr, int qp)
{
    int32 maxCoeff;
    int32 blk4x4, blk8x8;
    int16 * coeff = mb_cache_ptr->coff_Y;
