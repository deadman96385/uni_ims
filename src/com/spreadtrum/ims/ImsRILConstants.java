...
public class ImsRILConstants {
    ...
    final static int RIL_REQUEST_DISABLE_IMS = RIL_SPRD_REQUEST_BASE + 15;
    final static int RIL_REQUEST_GET_IMS_BEARER_STATE = RIL_SPRD_REQUEST_BASE + 16;
    final static int RIL_REQUEST_SET_SOS_INITIAL_ATTACH_APN = RIL_SPRD_REQUEST_BASE + 17;
    final static int RIL_REQUEST_IMS_HANDOVER = RIL_SPRD_REQUEST_BASE +18;
    final static int RIL_REQUEST_IMS_HANDOVER_STATUS_UPDATE = RIL_SPRD_REQUEST_BASE +19;
    final static int RIL_REQUEST_IMS_NETWORK_INFO_CHANGE = RIL_SPRD_REQUEST_BASE +20;
    final static int RIL_REQUEST_IMS_HANDOVER_CALL_END = RIL_SPRD_REQUEST_BASE +21;
    final static int RIL_REQUEST_GET_TPMR_STATE = RIL_SPRD_REQUEST_BASE +22;
    final static int RIL_REQUEST_SET_TPMR_STATE = RIL_SPRD_REQUEST_BASE +23;
    final static int RIL_REQUEST_IMS_WIFI_ENABLE = RIL_SPRD_REQUEST_BASE +24;
    final static int RIL_REQUEST_IMS_WIFI_CALL_STATE_CHANGE = RIL_SPRD_REQUEST_BASE +25;
    final static int RIL_REQUEST_IMS_UPDATE_DATA_ROUTER = RIL_SPRD_REQUEST_BASE +26;
    final static int RIL_REQUEST_IMS_HOLD_SINGLE_CALL = RIL_SPRD_REQUEST_BASE + 27;
    final static int RIL_REQUEST_IMS_MUTE_SINGLE_CALL = RIL_SPRD_REQUEST_BASE + 28;
    final static int RIL_REQUEST_IMS_SILENCE_SINGLE_CALL = RIL_SPRD_REQUEST_BASE + 29;
    final static int RIL_REQUEST_IMS_ENABLE_LOCAL_CONFERENCE = RIL_SPRD_REQUEST_BASE + 30;
    final static int RIL_REQUEST_IMS_NOTIFY_HANDOVER_CALL_INFO = RIL_SPRD_REQUEST_BASE + 31;
    final static int RIL_REQUEST_GET_IMS_SRVCC_CAPBILITY = RIL_SPRD_REQUEST_BASE + 32;
    final static int RIL_REQUEST_GET_IMS_PCSCF_ADDR  = RIL_SPRD_REQUEST_BASE + 33;
    final static int RIL_REQUEST_SET_IMS_PCSCF_ADDR  = RIL_SPRD_REQUEST_BASE + 34;
    final static int RIL_REQUEST_QUERY_FACILITY_LOCK_EXT = RIL_SPRD_REQUEST_BASE + 35;
    final static int RIL_REQUEST_GET_IMS_REGADDR = RIL_SPRD_REQUEST_BASE + 36;
