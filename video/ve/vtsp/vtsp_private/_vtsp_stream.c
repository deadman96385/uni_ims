...
/*
 * ======== _VTSP_checkStreamData ========
 *
 * given a valid infc and valid ptr to stream data with valid streamId,
 * check all args in data
 *
 * return: 
 *
 * VTSP_OK if stream data is ok
 * VTSP_E_STREAM_DATA if stream data is invalid
 *
 */
