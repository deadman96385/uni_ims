...
/* SPRD: add for VoWifi @{ */
#define RIL_REQUEST_IMS_HANDOVER (RIL_REQUEST_OTHER_BASE +43)
#define RIL_REQUEST_IMS_HANDOVER_STATUS_UPDATE (RIL_REQUEST_OTHER_BASE +44)
#define RIL_REQUEST_IMS_NETWORK_INFO_CHANGE (RIL_REQUEST_OTHER_BASE +45)
#define RIL_REQUEST_IMS_HANDOVER_CALL_END (RIL_REQUEST_OTHER_BASE +46)
#define RIL_REQUEST_GET_TPMR_STATE (RIL_REQUEST_OTHER_BASE +47)
#define RIL_REQUEST_SET_TPMR_STATE (RIL_REQUEST_OTHER_BASE +48)
#define RIL_REQUEST_IMS_WIFI_ENABLE (RIL_REQUEST_OTHER_BASE +49)
#define RIL_REQUEST_IMS_WIFI_CALL_STATE_CHANGE (RIL_REQUEST_OTHER_BASE +50)
#define RIL_REQUEST_IMS_UPDATE_DATA_ROUTER (RIL_REQUEST_OTHER_BASE +51)
/* @} */
#define RIL_SPRD_REQUEST_LAST RIL_REQUEST_IMS_UPDATE_DATA_ROUTER
...
#define RIL_EXT_REQUEST_QUERY_LTE_CTCC              (RIL_EXT_REQUEST_BASE + 8)
#define RIL_EXT_REQUEST_QUERY_LTE_CTCC_SINR         (RIL_EXT_REQUEST_BASE + 9)
#define RIL_EXT_REQUEST_QUERY_LTE_CTCC_SIMTYPE      (RIL_EXT_REQUEST_BASE + 10)
#define RIL_EXT_REQUEST_QUERY_LTE_CTCC_MMEI         (RIL_EXT_REQUEST_BASE + 11)
#define RIL_EXT_REQUEST_QUERY_DCE_SOFTWARE_VERSION  (RIL_EXT_REQUEST_BASE + 12)
...
/* SPRD: add for VoWifi @{ */
#define RIL_UNSOL_IMS_HANDOVER_REQUEST (RIL_SPRD_UNSOL_RESPONSE_BASE + 27)
#define RIL_UNSOL_IMS_HANDOVER_STATUS_CHANGE (RIL_SPRD_UNSOL_RESPONSE_BASE + 28)
#define RIL_UNSOL_IMS_NETWORK_INFO_CHANGE  (RIL_SPRD_UNSOL_RESPONSE_BASE + 29)
#define RIL_UNSOL_IMS_REGISTER_ADDRESS_CHANGE  (RIL_SPRD_UNSOL_RESPONSE_BASE + 30)
#define RIL_SPRD_UNSOL_RESPONSE_LAST RIL_UNSOL_IMS_REGISTER_ADDRESS_CHANGE
/* @} */
#endif
