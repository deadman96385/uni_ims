...
#define IICT_CFG2_OFF						0x48
#define IICT_CFG3_OFF						0x4c
...
//	volatile uint32 Dc_parameter[3];			//Dc_parameter[0]: [31:16]- Dc_parameter_1, Block 1 DC parameter [15:0]: Dc_parameter_0, Block 0 DC parameter
	...
	volatile uint32 iict_cfg1;					//[15:12]: qp_per = qp_y/6
												//[11:8]:  qp_per_c = qp_c/6
												//[7:4]:   qp_rem = qp_y%6
												//[3:0]:   qp_rem_c = qp_c%6
												//vp8 //[7:0] qp_y_ac;[15:8] qp_y_dc;[23:16] qp_uv_ac;[31:24] qp_uv_dc;
	...
	volatile uint32 iict_cfg2;					//vp8 //[7:0] qp_y2_ac;[15:8] qp_y2_dc;//weihu
	volatile uint32 iict_cfg3;					//vp8 //[0]:1 intra;[4]:0 4X4_size;//weihu
