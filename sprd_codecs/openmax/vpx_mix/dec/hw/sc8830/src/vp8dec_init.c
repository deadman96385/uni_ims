...
void Vp8Dec_InitVSP(VPXDecObject *vo)
{
    ...
    VSP_WRITE_REG(FRAME_ADDR_TABLE_BASE_ADDR + 0x10, (Vp8Dec_ExtraMem_V2P(vo, pc->FRAME_ADDR_4, EXTRA_MEM)) >> 3, "Frm_addr4: Partition info for MB Header");
