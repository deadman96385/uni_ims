...
#if 0
	memset(dec_picture_ptr->mv_ptr[0], 0, (img_ptr->frame_size_in_mbs << 5) * sizeof(int16));
	memset(dec_picture_ptr->mv_ptr[1], 0, (img_ptr->frame_size_in_mbs << 5) * sizeof(int16));
	memset(dec_picture_ptr->ref_pic_id_ptr[0], -2147483648, (img_ptr->frame_size_in_mbs << 4) * sizeof(int32));
	memset(dec_picture_ptr->ref_pic_id_ptr[1], -2147483648, (img_ptr->frame_size_in_mbs << 4) * sizeof(int32));
#endif	
...
//SCI_TRACE_LOW ("in H264Dec_exit_picture!\n");
...
#endif
//SCI_TRACE_LOW ("out H264Dec_exit_picture!\n");
	return;
}
/**---------------------------------------------------------------------------*
**                         Compiler Flag                                      *
