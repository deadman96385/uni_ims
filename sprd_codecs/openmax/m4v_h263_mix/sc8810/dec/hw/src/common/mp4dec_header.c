...
//	assert((vop_mode_ptr->time_inc_resolution >= 1) && (vop_mode_ptr->time_inc_resolution < 65536));
	...
	{	
		...
		{
			vop_mode_ptr->IntraQuantizerMatrix = g_default_intra_qmatrix_normal;
		}
		...
		{
			vop_mode_ptr->InterQuantizerMatrix = g_default_inter_qmatrix_normal;
		}
	}
	...
	if (Q_MPEG == vop_mode_ptr->QuantizerType && !vop_mode_ptr->VSP_used)
	{
		...
		{
			vop_mode_ptr->IntraQuantizerMatrix = g_default_intra_qmatrix_trans;
		}
		...
		{
			vop_mode_ptr->InterQuantizerMatrix = g_default_inter_qmatrix_trans;
		}
	}
