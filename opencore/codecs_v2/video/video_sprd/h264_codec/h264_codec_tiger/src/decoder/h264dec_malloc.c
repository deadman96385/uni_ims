...
{
//	SCI_TRACE_LOW("H264Dec_ExtraMem_V2Phy %x",vAddr);
 ...
 **	Note:
 *****************************************************************************/
PUBLIC void *H264Dec_ExtraMemCacheAlloc_64WordAlign(uint32 mem_size)
{
...
MMDecRet H264DecMemCacheInit(MMCodecBuffer *pBuffer)
{
	...
	SCI_TRACE_LOW("H264DecMemCacheInit: s_extra_mem_cache_size:%d\n", s_extra_mem_cache_size);
