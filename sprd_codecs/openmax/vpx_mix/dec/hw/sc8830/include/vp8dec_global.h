...
extern const int32 dc_qlookup[QINDEX_RANGE];
extern const int32 ac_qlookup[QINDEX_RANGE];

extern const int32 vp8_mb_feature_data_bits[MB_LVL_MAX];
...
extern const int32 vp8_mode_contexts[6][4];
