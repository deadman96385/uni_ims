/******************************************************************************
 ** File Name:    vp8dec_coef_update_probs.c                                             *
 ** Author:       Xiaowei.Luo                                                 *
 ** DATE:         07/04/2013                                                  *
...
const int32 dc_qlookup[QINDEX_RANGE] =
{
...
const int32 ac_qlookup[QINDEX_RANGE] =
{
...
const int32 vp8_mb_feature_data_bits[MB_LVL_MAX] = {7, 6};

//__attribute__((aligned(8)))
const vp8_prob default_coef_probs [BLOCK_TYPES][COEF_BANDS][PREV_COEF_CONTEXTS][ENTROPY_NODES] =
{
    {   /* Block Type ( 0 ) */
        {   /* Coeff Band ( 0 )*/
...
const int32 vp8_mode_contexts[6][4] =
{
    {
        // 0
        7,     1,     1,   143,
