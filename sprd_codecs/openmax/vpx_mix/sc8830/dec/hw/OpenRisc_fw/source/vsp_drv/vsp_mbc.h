...
typedef struct  
{
	...
	volatile uint32 VP8_CFG0;			// [0]:		mb_type, 0-inter, 1-intra
										// [1]:		IS_IPCM, 0-normal, 1-IPCM
										// [5:2]:	MB_AVAIL, b0-tr, b1-t, b2-l, b3-tl
										// [7:6]:	IPRED_TYPE, 0-4x4, 1-16x16, 2-8x8
										// [9:8]:	intra chroma prediction mode
										// [16:10]:	MB_Y_ID
										// [31]:	IS_LAST_MB
	volatile uint32 VP8_CFG1;			// [23:0]	MB_CBP, including DC block
										// [30:24]	MB_X_ID
