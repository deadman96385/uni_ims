...
#define ONEFRAME_BITSTREAM_BFR_SIZE	(250*1024)  //for bitstream size of one encoded frame.
...
// 	int		resync_dis;
	...
	const uint16 *pQuant_pa;
	const uint16 *pDC_scaler;
...
typedef int32 (*EncPVOP_func) (ENC_VOP_MODE_T *vop_mode_ptr, int32 time_stamp);
