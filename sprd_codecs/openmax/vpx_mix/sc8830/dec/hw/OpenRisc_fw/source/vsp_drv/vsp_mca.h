...
typedef struct  
{
	...
	volatile uint32 MCA_DEBUG;			//[24]: MCA_STATUS, 0 - idle, 1 - busy
										...
										//[2:0]: MCA FSM state
	volatile uint32 VP8_MCA_CFG0;		// [6:0]:	cur_mb_y
										// [13:7]:	cur_mb_x
										// [14]:	Is_intra
										// [16:15]:	mb_mode, 0-16x16, 1-16x8, 2-8x16, 3-8x8
										// [18:17]:	submb_mode0, if mb_mode is 3, then 0-8x8, 1-8x4, 2-4x8, 3-4x4
										// [20:19]:	submb_mode1
										// [22:21]:	submb_mode2
										// [24:23]:	submb_mode3
	volatile uint32 VP8_MCA_MV[16];		// [11:0]:	sub_mv_row_0-15
										// [27:12]:	sub_mv_col_0-15, sign-extension
}VSP_MCA_REG_T;
