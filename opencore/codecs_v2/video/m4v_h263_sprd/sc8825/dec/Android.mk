...
LOCAL_CFLAGS :=  -fno-strict-aliasing -DMPEG4_DEC -D_VSP_LINUX_  -D_VSP_  -D_MP4CODEC_DATA_PARTITION_ -DCHIP_ENDIAN_LITTLE  -DCHIP_8825 $(PV_CFLAGS)
...
LOCAL_C_INCLUDES := \
	$(PV_TOP)/codecs_v2/video/m4v_h263_sprd/sc8825/dec/include \
	$(PV_TOP)/codecs_v2/video/m4v_h263_sprd/sc8825/src/common \
	$(PV_TOP)/codecs_v2/video/m4v_h263_sprd/sc8825/src/hw \
	$(PV_TOP)/codecs_v2/video/m4v_h263_sprd/sc8825/src/sw \
