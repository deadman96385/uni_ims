...
typedef struct
{
    ...
    uint32  FrameRate;
    uint32	qp_ISLICE;     				// first I frame's QP; 1 ~ 31, default QP value if the Rate Control is disabled
    uint32	qp_PSLICE;     				// first P frame's QP; 1 ~ 31, default QP value if the Rate Control is disabled
