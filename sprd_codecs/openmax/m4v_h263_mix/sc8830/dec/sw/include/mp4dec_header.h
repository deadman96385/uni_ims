...
MMDecRet Mp4Dec_DecH263Header(Mp4DecObject *vo);
MMDecRet Mp4Dec_DecMp4Header(DEC_VOP_MODE_T *vop_mode_ptr, uint32 uOneFrameLen);
MMDecRet Mp4Dec_FlvH263PicHeader(Mp4DecObject *vo);
MMDecRet Mp4Dec_DecGobHeader(DEC_VOP_MODE_T *vop_mode_ptr);
MMDecRet Mp4Dec_GetVideoPacketHeader(DEC_VOP_MODE_T *vop_mode_ptr, uint32 uAddBits);
BOOLEAN Mp4Dec_CheckResyncMarker(DEC_VOP_MODE_T *vop_mode_ptr, uint32 uAddbit);
BOOLEAN Mp4Dec_SearchResynCode(DEC_VOP_MODE_T * vop_mode_ptr);
