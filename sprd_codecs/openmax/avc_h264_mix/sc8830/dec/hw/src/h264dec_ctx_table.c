...
extern WORD_ALIGN const int32 INIT_MB_TYPE_I[1][3][11][2] =
{
    ...
    //----- model 0 -----
    {
        ...
        { {  20, -15} , {   2,  54} , {   3,  74} , {  20, -15} , {   2,  54} , {   3,  74} , { -28, 127} , { -23, 104} , {  -6,  53} , {  -1,  54} , {   7,  51} }, // SI (unused at the moment)//0-10
...
extern WORD_ALIGN const int32 INIT_MB_TYPE_P[3][3][11][2] =
{
    ...
    //27,28,29,N,30,31,32,24,25,26,N
    //----- model 0 -----
    {
        {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED },
        { {  23,  33} , {  23,   2} , {  21,   0} ,  CTX_UNUSED , {   1,   9} , {   0,  49} , { -37, 118} , {   5,  57} , { -13,  78} , { -11,  65} , {   1,  62} },//11-20,33-35
        { {  26,  67} , {  16,  90} , {   9, 104} ,  CTX_UNUSED , { -46, 127} , { -20, 104} , {   1,  67} , {  18,  64} , {   9,  43} , {  29,   0} ,  CTX_UNUSED }//27-32,24-26
    },
    //----- model 1 -----
    {
        {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED },
...
//36,37,38,39
{
    //----- model 0 -----
    {
        ...
        {   {  12,  49} , {  -4,  73} , {  17,  50} , CTX_UNUSED , CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED },
        { {  -6,  86} , { -17,  95} , {  -6,  61} , {   9,  45} ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED }
    },
    //----- model 1 -----
    {
        {  {   9,  50} ,  {  -3,  70} , {  10,  54} , CTX_UNUSED , CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED },
        { {   6,  69} , { -13,  90} , {   0,  52} , {   8,  43} ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED }
    },
    //----- model 2 -----
    {
        {   {   6,  57} ,   { -17,  73} , {  14,  57} , CTX_UNUSED ,CTX_UNUSED , CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED },
...
extern WORD_ALIGN const int32 INIT_MV_RES_P[3][2][10][2] =
{
    ...
    //43...46,50...53
    {
        ...
        { {  -3,  69} ,  CTX_UNUSED , {  -6,  81} , { -11,  96} ,   {   0,  58} ,  CTX_UNUSED , {  -3,  76} , { -10,  94} , CTX_UNUSED , CTX_UNUSED },
        { {   6,  55} , {   7,  67} , {  -5,  86} , {   2,  88} ,   {   5,  54} , {   4,  69} , {  -3,  81} , {   0,  88} , CTX_UNUSED , CTX_UNUSED }

    },
    //----- model 1 -----
    {
        { {  -2,  69} ,  CTX_UNUSED , {  -5,  82} , { -10,  96} ,   {   1,  56} ,  CTX_UNUSED , {  -3,  74} , {  -6,  85} ,  CTX_UNUSED ,CTX_UNUSED },
        { {   2,  59} , {   2,  75} , {  -3,  87} , {  -3, 100} ,  {   0,  59} , {  -3,  81} , {  -7,  86} , {  -5,  95} , CTX_UNUSED , CTX_UNUSED }
    },
    //----- model 2 -----
    {
        { { -11,  89} ,  CTX_UNUSED , { -15, 103} , { -21, 116} ,   {   1,  63} ,  CTX_UNUSED , {  -5,  85} , { -13, 106} ,  CTX_UNUSED ,CTX_UNUSED },
        { {  19,  57} , {  20,  58} , {   4,  84} , {   6,  96} ,   {   5,  63} , {   6,  75} , {  -3,  90} , {  -1, 101} ,  CTX_UNUSED ,CTX_UNUSED }
    }
};
...
extern WORD_ALIGN const int32 INIT_LAST_I[1][8][15][2] =
{
    ...
    //----- model 0 -----
    {
        { {  24,   0} , {  15,   9} , {   8,  25} , {  13,  18} , {  15,   9} , {  13,  19} , {  10,  37} , {  12,  18} , {   6,  29} , {  20,  33} , {  15,  30} , {   4,  45} , {   1,  58} , {   0,  62} , {   7,  61} },//166-180
...
#else
        {  {  -3,  75} , {  -1,  23} , {   1,  34} , {   1,  43} , {   0,  54} },//426-430
#endif
        {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED },
        { { -12,  92} , { -15,  55} , { -10,  60} , {  -6,  62} , {  -4,  65} },//247-251
        { { -11,  97} , { -20,  84} , { -11,  79} , {  -6,  73} , {  -4,  74} },//257-261
        { {  -8,  78} , {  -5,  33} , {  -4,  48} , {  -2,  53} , {  -3,  62} },//266-270
        {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED }
    }
};
...
extern WORD_ALIGN const int32 INIT_ABS_I[1][8][5][2] =//coeff_abs_level_minus1[ ]
{
    //----- model 0 -----
    {
        ...
        {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED },
#else
        {  {  -2,  55} , {   0,  61} , {   1,  64} , {   0,  68} , {  -9,  92} },//431-435

#endif
        {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED },
        { { -12,  73} , {  -8,  76} , {  -7,  80} , {  -9,  88} , { -17, 110} },//252-256
...
WORD_ALIGN const int32 INIT_FLD_MAP_P[3][8][15][2] =
{
    //----- model 0 -----
    {
