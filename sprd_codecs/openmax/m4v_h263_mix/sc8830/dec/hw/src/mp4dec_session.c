...
//    }
	...
	vop_mode_ptr->data_partition_buffer_ptr = Mp4Dec_ExtraMemAlloc_64WordAlign((uint32)((mb_num_x * mb_num_y)*32));
	vop_mode_ptr->data_partition_buffer_Addr = (uint32)vop_mode_ptr->data_partition_buffer_ptr;	
