...
typedef struct dec_buffer_seq_info_tag
{
	...
	uint32 imgVAddr;	//imgUVAddr = ((uint32)imgU>>8)
...
typedef struct dec_vop_mode_tag 
{
	...
	MCBPC_TABLE_CODE_LEN_T *pMCBPCtabintra;
	MCBPC_TABLE_CODE_LEN_T *pMCBPCtab;
	CBPY_TABLE_CODE_LEN_T *pCBPYtab;

	MV_TABLE_CODE_LEN_T *pTMNMVtab0;
	MV_TABLE_CODE_LEN_T *pTMNMVtab1;
	MV_TABLE_CODE_LEN_T *pTMNMVtab2;
