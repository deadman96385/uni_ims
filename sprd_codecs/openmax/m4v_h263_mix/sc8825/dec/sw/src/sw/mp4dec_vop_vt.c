 ...
 **	Note:			Based on 8800G
 *****************************************************************************/
PUBLIC MMDecRet Mp4Dec_DecIVOP_vt(MP4DecObject *vd, DEC_VOP_MODE_T *vop_mode_ptr)
{
	int32 pos_y, pos_x;
	int32 rsc_found;
...
#endif
PUBLIC MMDecRet Mp4Dec_DecPVOP_vt(MP4DecObject *vd, DEC_VOP_MODE_T *vop_mode_ptr)
{
	int32 pos_y, pos_x;
	int32 rsc_found;
...
PUBLIC MMDecRet Mp4Dec_DecBVOP_vt(MP4DecObject *vd, DEC_VOP_MODE_T * vop_mode_ptr)
{
	MMDecRet ret = MMDEC_OK;
	int32 pos_y, pos_x;
