...
import com.spreadtrum.ims.ImsServiceImpl.Listener;
...
public class ImsService extends Service {
    ...
    public void onCreate() {
        ...
        ServiceManager.addService("ims_ex", mImsServiceExBinder);
    ...
    public void updateImsFeature(){
        ...
        Log.i(TAG,"updateImsFeature->mWifiRegistered:"+mWifiRegistered +" volteRegistered:"+volteRegistered
    ...
    private boolean isVoLTERegisted() {
        ...
        for (Integer id : mImsServiceImplMap.keySet()) {
            if(mImsServiceImplMap.get(id).isImsRegistered()){
