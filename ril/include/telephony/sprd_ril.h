...
/* SPRD: add for VoWifi @{ */
#define RIL_REQUEST_IMS_HANDOVER (RIL_SPRD_REQUEST_BASE +25)
#define RIL_REQUEST_IMS_HANDOVER_STATUS_UPDATE (RIL_SPRD_REQUEST_BASE +26)
#define RIL_REQUEST_IMS_NETWORK_INFO_CHANGE (RIL_SPRD_REQUEST_BASE +27)
#define RIL_REQUEST_IMS_HANDOVER_CALL_END (RIL_SPRD_REQUEST_BASE +28)
#define RIL_REQUEST_GET_TPMR_STATE (RIL_SPRD_REQUEST_BASE +29)
#define RIL_REQUEST_SET_TPMR_STATE (RIL_SPRD_REQUEST_BASE +30)
#define RIL_REQUEST_IMS_WIFI_ENABLE (RIL_SPRD_REQUEST_BASE +31)
#define RIL_REQUEST_IMS_WIFI_CALL_STATE_CHANGE (RIL_SPRD_REQUEST_BASE +32)
#define RIL_REQUEST_IMS_UPDATE_DATA_ROUTER (RIL_SPRD_REQUEST_BASE +33)
#define RIL_REQUEST_OTHER_BASE   RIL_REQUEST_IMS_UPDATE_DATA_ROUTER
/* @} */
