...
PVMFStatus PVMFSMRTSPTUnicastNode::SetSourceInitializationData(OSCL_wString& aSourceURL, PVMFFormatType& aSourceFormat, OsclAny* aSourceData, uint32 aClipIndex, PVMFFormatTypeDRMInfo aType)
{
    ...
    if ((aSourceFormat == PVMF_MIME_DATA_SOURCE_RTSP_URL)||(aSourceFormat == PVMF_MIME_DATA_SOURCE_RTSP_TUNNELLING))
    {
        ...
        iSessionSourceInfo->_sessionType = PVMF_MIME_DATA_SOURCE_RTSP_URL;
...
PVMFStatus PVMFSMRTSPTUnicastNode::GetRTSPPluginSpecificValues(PVMFSMFSPBaseNodeCommand& aCmd)
{
