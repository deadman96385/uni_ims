 ...
 *****************************************************************************/
#ifndef _VSP_MP4_DEC_H_
#define _VSP_MP4_DEC_H_
...
**                            Macro Definitions                               *
**---------------------------------------------------------------------------*/
#define MP4DEC_OR_RUN_SIZE		                (0x100000)      //byte unit
#define MP4DEC_OR_INTER_START_ADDR		MP4DEC_OR_RUN_SIZE
#define MP4DEC_OR_INTER_MALLOC_SIZE		(0x100000)      //byte unit
...
typedef struct mp4dec_share_ram_info
{
	// Offset 0x0 ;	
