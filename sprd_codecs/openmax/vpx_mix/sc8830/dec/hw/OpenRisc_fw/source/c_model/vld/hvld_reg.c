...
// 	int			ctx_bin0;
	...
	else
	{
		if (blk_cat == 0)
		{
			ctx_ptr = (uint32*)&(g_hvld_reg_ptr->ctx_bin0_cat0);
		}
		else if (blk_cat == 1)
		{
			ctx_ptr = (uint32*)&(g_hvld_reg_ptr->ctx_bin0_cat1);
		}		
		else if (blk_cat == 2)
		{
			ctx_ptr = (uint32*)&(g_hvld_reg_ptr->ctx_bin0_cat2);
		}
		else if (blk_cat == 3)
		{
			ctx_ptr = (uint32*)&(g_hvld_reg_ptr->ctx_bin0_cat3);
		}
#ifdef LUMA_8x8_CABAC
		else if (blk_cat == 5)
		{
			ctx_ptr = (uint32*)&(g_hvld_reg_ptr->ctx_bin0_cat5);
		}
#endif
		else
		{
			ctx_ptr = (uint32*)&(g_hvld_reg_ptr->ctx_bin0_cat4);
		}
...
// 	int			ctx_bin0;
	...
	else
	{
		if (blk_cat == 0)
		{
			ctx_ptr = (uint32*)(&(g_hvld_reg_ptr->ctx_binoth_cat0));
		}
		else if (blk_cat == 1)
		{
			ctx_ptr = (uint32*)(&(g_hvld_reg_ptr->ctx_binoth_cat1));
		}		
		else if (blk_cat == 2)
		{
			ctx_ptr = (uint32*)(&(g_hvld_reg_ptr->ctx_binoth_cat2));
		}
		else if (blk_cat == 3)
		{
			ctx_ptr = (uint32*)(&(g_hvld_reg_ptr->ctx_binoth_cat3));
		}
#ifdef LUMA_8x8_CABAC
		else if (blk_cat == 5)
		{
			ctx_ptr = (uint32*)(&(g_hvld_reg_ptr->ctx_binoth_cat5));
		}
#endif
		else
		{
			ctx_ptr = (uint32*)(&(g_hvld_reg_ptr->ctx_binoth_cat4));
		}
