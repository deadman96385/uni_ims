...
#define RIL_REQUEST_SEND_AT (RIL_SPRD_REQUEST_BASE + 28)
#define RIL_REQUEST_SET_SPEED_MODE (RIL_SPRD_REQUEST_BASE + 29)
#define RIL_REQUEST_SET_SIM_SLOT_CFG  (RIL_SPRD_REQUEST_BASE + 30)  //SPRD:added for choose WCDMA SIM
#define RIL_REQUEST_GET_SIMLOCK_REMAIN_TIMES (RIL_SPRD_REQUEST_BASE + 31)
#define RIL_REQUEST_CALL_CSFALLBACK_ACCEPT  (RIL_SPRD_REQUEST_BASE + 32) //SPRD:add for LTE-CSFB to handle CS fall back of MT call
#define RIL_REQUEST_CALL_CSFALLBACK_REJECT  (RIL_SPRD_REQUEST_BASE + 33) //SPRD:add for LTE-CSFB to handle CS fall back of MT call
#define RIL_REQUEST_SET_PRIORITY_NETWORK_MODE  (RIL_SPRD_REQUEST_BASE + 34) //SPRD:add for priotiry network mode
#define RIL_REQUEST_GET_PRIORITY_NETWORK_MODE  (RIL_SPRD_REQUEST_BASE + 35) //SPRD:add for priotiry network mode
//SPRD: For WIFI get BandInfo report from modem, BRCM4343+9620, Zhanlei Feng added. 2014.06.20 START
#define RIL_REQUEST_GET_BAND_INFO (RIL_SPRD_REQUEST_BASE+36)
#define RIL_REQUEST_SWITCH_BAND_INFO_REPORT (RIL_SPRD_REQUEST_BASE+37)
#define RIL_REQUEST_SWITCH_3_WIRE (RIL_SPRD_REQUEST_BASE+38)
#define RIL_REQUEST_SWITCH_BT (RIL_SPRD_REQUEST_BASE+39)
#define RIL_REQUEST_SWITCH_WIFI (RIL_SPRD_REQUEST_BASE+40)
...
#define RIL_REQUEST_STOP_QUERY_AVAILABLE_NETWORKS (RIL_SPRD_REQUEST_BASE+41)
/*@}*/
#define RIL_REQUEST_GET_CURRENT_CALLS_VOLTE (RIL_SPRD_REQUEST_BASE + 42)
#define RIL_REQUEST_SET_IMS_VOICE_CALL_AVAILABILITY (RIL_SPRD_REQUEST_BASE + 43)
#define RIL_REQUEST_GET_IMS_VOICE_CALL_AVAILABILITY (RIL_SPRD_REQUEST_BASE + 44)
#define RIL_REQUEST_INIT_ISIM  (RIL_SPRD_REQUEST_BASE + 45)
#define RIL_REQUEST_REGISTER_IMS_IMPU  (RIL_SPRD_REQUEST_BASE + 46)
#define RIL_REQUEST_REGISTER_IMS_IMPI  (RIL_SPRD_REQUEST_BASE + 47)
#define RIL_REQUEST_REGISTER_IMS_DOMAIN  (RIL_SPRD_REQUEST_BASE + 48)
#define RIL_REQUEST_DISABLE_IMS  (RIL_SPRD_REQUEST_BASE + 49)
#define RIL_REQUEST_REGISTER_IMS_IMEI  (RIL_SPRD_REQUEST_BASE + 50)
#define RIL_REQUEST_VOLTE_CALL_REQUEST_MEDIA_CHANGE (RIL_SPRD_REQUEST_BASE + 51)
#define RIL_REQUEST_VOLTE_CALL_RESPONSE_MEDIA_CHANGE (RIL_SPRD_REQUEST_BASE + 52)
#define RIL_REQUEST_REGISTER_IMS_XCAP (RIL_SPRD_REQUEST_BASE + 53)
#define RIL_REQUEST_REGISTER_IMS_BSF (RIL_SPRD_REQUEST_BASE + 54)
#define RIL_REQUEST_SET_IMS_SMSC (RIL_SPRD_REQUEST_BASE + 55)
#define RIL_REQUEST_VOLTE_CALL_FALL_BACK_TO_VOICE (RIL_SPRD_REQUEST_BASE + 56)
#define RIL_REQUEST_SET_INITIAL_ATTACH_IMS_APN (RIL_SPRD_REQUEST_BASE+57)
#define RIL_REQUEST_QUERY_CALL_FORWARD_STATUS_URI (RIL_SPRD_REQUEST_BASE+58)
#define RIL_REQUEST_SET_CALL_FORWARD_URI (RIL_SPRD_REQUEST_BASE+59)
#define RIL_REQUEST_VOLTE_INITIAL_GROUP_CALL (RIL_SPRD_REQUEST_BASE+60)
#define RIL_REQUEST_VOLTE_ADD_TO_GROUP_CALL (RIL_SPRD_REQUEST_BASE+61)
#define RIL_REQUEST_VOLTE_SET_CONFERENCE_URI (RIL_SPRD_REQUEST_BASE +62)
#define RIL_REQUEST_ENABLE_BROADCAST_SMS (RIL_SPRD_REQUEST_BASE+63)
