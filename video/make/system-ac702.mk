...
SYSTEM_CFLAGS += -DANDROID_JELLYBEAN
...
# NDK log
SYSTEM_CFLAGS += -DOSAL_LOG_NDK

# Enable Regex Support
#SYSTEM_CFLAGS += -DOSAL_ENABLE_REGEX

# OSAL_ARCH option flags
#SYSTEM_CFLAGS += -DOSAL_ARCH_ENABLE_COUNT
...
ifeq ($(CSM),y)
ifeq ($(CSM_SAPP),n)
SYSTEM_CFLAGS += -DCSM_DISABLE_SAPP
endif
# Define this for debug logging in the GAPP application
