...
typedef MMDecRet (*DecIVOP_func)(struct video_data_tag *, DEC_VOP_MODE_T *vop_mode_ptr);
typedef MMDecRet (*DecPVOP_func)(struct video_data_tag *, DEC_VOP_MODE_T *vop_mode_ptr);
typedef MMDecRet (*DecBVOP_func)(struct video_data_tag *, DEC_VOP_MODE_T *vop_mode_ptr);

//typedef  MMDecRet (*Dec_frm_level_sync_func) (MMDecInput *dec_input_ptr, MMDecOutput *dec_output_ptr, DEC_VOP_MODE_T *vop_mode_ptr);

typedef struct video_data_tag
{
