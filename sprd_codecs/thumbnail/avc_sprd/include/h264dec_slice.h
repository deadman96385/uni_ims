...
PUBLIC void H264Dec_decode_one_slice_I_hw (H264DecContext *img_ptr);
PUBLIC void H264Dec_decode_one_slice_P_hw (H264DecContext *img_ptr);
PUBLIC void H264Dec_decode_one_slice_B_hw (H264DecContext *img_ptr);

PUBLIC void H264Dec_decode_one_slice_I_sw (H264DecContext *img_ptr);
PUBLIC void H264Dec_decode_one_slice_P_sw (H264DecContext *img_ptr);
PUBLIC void H264Dec_decode_one_slice_B_sw (H264DecContext *img_ptr);
