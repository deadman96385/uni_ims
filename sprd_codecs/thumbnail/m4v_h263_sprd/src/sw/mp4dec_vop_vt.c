 ...
 **	Note:			Based on 8800G
 *****************************************************************************/
PUBLIC MMDecRet Mp4Dec_DecIVOP_vt(VIDEO_DATA_T *vd, DEC_VOP_MODE_T *vop_mode_ptr)
{
	int32 pos_y, pos_x;
	int32 rsc_found;
...
#endif
PUBLIC MMDecRet Mp4Dec_DecPVOP_vt(VIDEO_DATA_T *vd, DEC_VOP_MODE_T *vop_mode_ptr)
{
	int32 pos_y, pos_x;
	int32 rsc_found;
...
PUBLIC MMDecRet Mp4Dec_DecBVOP_vt(VIDEO_DATA_T *vd, DEC_VOP_MODE_T * vop_mode_ptr)
{
	MMDecRet ret = MMDEC_OK;
	int32 pos_y, pos_x;
